<nav x-data="{ open: false }" class="dark:bg-cyan-700">
  <div>
      <div class="relative">
          ...
          <!-- For large screens -->
          <div class="dark:bg-cyan-700 bg-gray-50 px-5 py-8">
            <div class="container mx-auto flex items-center justify-between">
              ...
              <ul class="hidden w-8/12 md:flex items-center justify-center space-x-5">
                <li>
                ...
                <li x-data="{ open: false }" x-on:mouseleave="open = false">
                  <div x-on:mouseenter="open = true">
                    ...
                    <div x-show="open" class="absolute z-10 bg-white shadow-md py-2.5 mt-10" x-on:mouseleave="open = false">
                      <a href="javascript:void(0)" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900">Bovenkleding</a>
                ...
                <li x-data="{ open: false }" x-on:mouseleave="open = false">
                  <div x-on:mouseenter="open = true">
                    ...
                    <div x-show="open" class="absolute z-10 bg-white shadow-md py-2 mt-10 " x-on:mouseleave="open = false">
                      <a href="javascript:void(0)" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900">Onderkleding</a>
                ...
                <li x-data="{ open: false }" x-on:mouseleave="open = false">
                  <div x-on:mouseenter="open = true">
                    ...
                    <div x-show="open" class="absolute z-10 bg-white shadow-md py-2 mt-10 " x-on:mouseleave="open = false">
                      <a href="javascript:void(0)" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900">Schoenen</a>
                ...
                <li x-data="{ open: false }" x-on:mouseleave="open = false">
                  <div x-on:mouseenter="open = true">
                    <a href="javascript:void(0)" class="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">Accessoires</a>
                    <div x-show="open" class="absolute z-10 bg-white shadow-md py-2 mt-10" x-on:mouseleave="open = false">
                      <a href="javascript:void(0)" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900">Accessoires</a>
              ...
              <div class="hidden md:flex items-center space-x-1">
                <div x-data="{ open: false }" @click.away="open = false">
                  ...
                  <div x-show="open" class="absolute z-10 bg-white shadow-md py-2.5 mt-10 right-20">
                    @guest
              ...
              <div class="flex items-center mr-16">
                ...
                <div class="mr-2 flex items-center sm:hidden">
                  <button @click="open = !open" class="inline-flex items-center justify-center p-2 text-white hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
